...
And say you wanted to spice things up by adding 1 to every number in the list. You're sure theres an easy way to do this in R (probably by importing some library nobody cares about) but you know theres an even easier way of doing it in python. And now, with Reticulate, you can simply do: 
...
Just like that, you have a list of yor favorite primes in the same list of your favorite primes, a prime example of just how useful Retirculate can be!
